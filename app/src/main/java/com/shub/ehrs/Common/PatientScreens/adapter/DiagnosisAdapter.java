...
public class DiagnosisAdapter extends RecyclerView.Adapter<DiagnosisAdapter.RecyclerviewHolder> {

    Context context;
    List<DiagnosisData> diagnosisDataList;
    List<DiagnosisData> filteredDiagnosisDataList;

    public DiagnosisAdapter(Context context, List<DiagnosisData> diagnosisDataList) {
    ...
    @NonNull
    @Override
    public DiagnosisAdapter.RecyclerviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.diagnosis_row_item, parent, false);
        return new DiagnosisAdapter.RecyclerviewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DiagnosisAdapter.RecyclerviewHolder holder, final int position) {
    ...
    public int getItemCount() {
        return filteredDiagnosisDataList.size();
    }
